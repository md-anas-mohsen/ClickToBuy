...
const Profile = ({ match, history }) => {
  ...
  return (
    <div className="profile">
      {!loading && <MetaData title={`${user.full_name}'s Profile`} />}
        ...
        >
          ...
          >
            ...
            <Typography variant="h4">
              {!loading ? user.full_name : <Skeleton width={400} />}
            </Typography>
          ...
          {match.path === "/myprofile" ? (
            <Grid className="profile__main__info" direction="column" xs={12}>
              ...
              <Grid container align="left" direction="column" xs={12}>
                ...
                <Grid item>
                  <Typography variant="h5">
                    {!loading ? (
                      String(user.created_at).substring(0, 10)
                    ) : (
                      <Skeleton width={400} />
                    )}
                  </Typography>
            ...
            <Grid container justifyContent="center">
              <Grid item xs={12} md={11} style={{ overflowX: sm && "scroll" }}>
                <OrderList />
              </Grid>
            </Grid>
          ) : (
